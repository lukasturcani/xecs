...
class PyField(typing.Generic[T]):
    @staticmethod
    def p_with_indices(indices: ArrayViewIndices) -> PyField[T]: ...
...
class Float32:
    ...
    def get(self, index: int, default: float = ...) -> float: ...
    def to_str(self) -> str: ...
...
class Int32:
    ...
    def get(self, index: int, default: int = ...) -> int: ...
    def to_str(self) -> str: ...
...
class Bool:
    ...
    def get(self, index: int, default: bool = ...) -> bool: ...
    def to_str(self) -> str: ...
