...
def main() -> None:
    ...
    app.add_pool(xx.Transform2, num_boids + 1)
    app.add_pool(Velocity, num_boids)
    app.add_pool(Separation, num_boids)
    app.add_pool(Alignment, num_boids)
    app.add_pool(Cohesion, num_boids)
    app.add_pool(Rectangle, 1)
    app.add_pool(Polygon, num_boids)
    app.run()
